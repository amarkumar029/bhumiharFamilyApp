                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <View style={styles.formItem}>
                            ...
                            {/* Assuming Input type="date" is handled by your custom Input component */}
                            <Input
                                placeholder="YYYY-MM-DD"
                                value={field.value}
                                onChangeText={field.onChange}
                            />
                            {getErrorMessage('dateOfBirth') && <Text style={styles.errorMessage}>{getErrorMessage('dateOfBirth')}</Text>}
                        </View>
                    )}
                />
            </View>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#F9FAFB', // Matches light background
  },
  contentContainer: {
